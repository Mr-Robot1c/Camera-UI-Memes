...
export default function App() {
  ...
  return <div className="app-shell">
    <header className="app-header">
      <a className="brand" href="/" aria-label="Meme Camera — home" onClick={e => e.preventDefault()}><span className="brand-mark"><Camera size={23} strokeWidth={2.5}/></span><span>Meme Camera</span></a>
    ...
    <footer className="app-footer"><span>Made for your main-character moment.</span></footer>
